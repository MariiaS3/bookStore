...
public class SwaggerConfig {
    ...
    private ApiInfo apiMetaData(){
        return new ApiInfo("Book Store REST API", 
                            "All api's for book store aplication",
                            "1.0", 
                            "term  and condition url", 
                             new Contact("BookStore Admin", "https://book-store-web.herokuapp.com", "bookstore@gmail.com"),
                             "book store license",
                             "license url",
